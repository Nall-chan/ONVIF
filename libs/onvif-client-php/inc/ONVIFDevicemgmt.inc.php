...
class ONVIFDevicemgmt extends ONVIF
{
    ...
    {
        return $this->client->SetHostname([
            'Name' => $hostname
        ]);
    }
    ...
    {
        $this->client->SetSystemFactoryDefault([
    ...
    {
        $this->client->SetRemoteDiscoveryMode([
    ...
    {
        return $this->client->SetHostnameFromDHCP([
            'FromDHCP' => $active
        ]);
    }
    ...
    {
        $this->client->SetNetworkProtocols([
            'NetworkProtocols' => [
                'Name'    => $protocol,
                'Enabled' => $enable,
                'Port'    => $port
    ...
    {
        $this->client->SetNetworkDefaultGateway([
            'IPv4Address' => $address
        ]);
    }
    ...
    {
        $this->client->SetZeroConfiguration([
    ...
    {
        $this->client->SendAuxiliaryCommand([
