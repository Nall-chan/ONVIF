...
[![Module Version](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2FNall-chan%2FONVIF%2Frefs%2Fheads%2Fmaster%2Flibrary.json&query=%24.version&label=Modul%20Version&color=blue)](https://community.symcon.de/t/modul-onvif-profil-s-fuer-ip-kameras-und-encoder/52036)
[![Symcon Version](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2FNall-chan%2FONVIF%2Frefs%2Fheads%2Fmaster%2Flibrary.json&query=%24.compatibility.version&suffix=%3E&label=Symcon%20Version&color=green)](https://www.symcon.de/de/service/dokumentation/installation/migrationen/v80-v81-q3-2025/)  
...
- [4. Einrichten der Instanzen in IP-Symcon](#4-einrichten-der-instanzen-in-ip-symcon)
  ...
  - [Konfigurationsseite PTZ](#konfigurationsseite-ptz)
    - [HTML-Box / Kachel Visualisierung](#html-box--kachel-visualisierung)
...
#### HTML-Box / Kachel Visualisierung

Es besteht die Möglichkeit PTZ Steuerelemente als Overlay im Video-Stream darzustellen.  
Diese Funktion wird im WebFront über eine String-Variable mit HTMLBox-Profil (für die Darstellung), und einen Webhook (für die Steuerung), realisiert.  
...
Für die Kachel Visualisierung wird eine Instanzspezifische Darstellung angeboten, welche jedoch weiterhin den "alten" Video-Stream des WebFront nutzt.

| Name                  | Typ     | Text                                                |
| --------------------- | ------- | --------------------------------------------------- |
| EnablePTZTileDisplay  | boolean | Aktiviert die Instanzspezifische Kachel Darstellung |
| EnablePTZHTMLDisplay  | boolean | Aktiviere die HTML-Box Darstellung                  |
| EnablePanTilt         | boolean | Aktiviere Schwenk/Neige                             |
| EnableZoom            | boolean | Aktiviere Zoom                                      |
